Shader "Custom/TransparencyByHeight"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        void surf (Input IN, inout SurfaceOutputStandard o)
        {
            ...
            fixed4 c = tex2D (_MainTex, IN.uv_MainTex) * IN.vert_color;
            o.Albedo = c.rgb;
    ...
    FallBack "Diffuse"  //ここを変えると良くなる可能性がある．→http://tsumikiseisaku.com/blog/shader-tutorial-transparent/
}
